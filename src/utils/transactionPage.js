...
const allowedReceiptMimeTypes = new Set(["image/png", "image/jpeg", "image/jpg", "image/heic", "image/heif", "image/webp"]);

export const RECEIPT_IMAGE_ACCEPT = "image/png,image/jpeg,image/jpg,image/heic,image/heif,image/webp,.png,.jpg,.jpeg,.heic,.heif,.webp";
